...
(function(){
  "use strict";
  var $id, $q, $cc, contains, format02d, formatTime, after, every, timeIt, decompress, getStep, setProgress, progressTimer, runProgressTimer, updatePage, checksumCache, calcSymbolChecksum, shouldUseCustomFont, undrawableChecksum, toggleHovered, postprocessPage, socket, retryEvery, retryCount, disconnect, connect;
  $id = function(it){
