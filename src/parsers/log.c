...
#line 47 "../src/parsers/log.c"
	...
	{
tr0:
#line 55 "../src/parsers/log.c.rl"
	{{( f.p) = (( f.te))-1;}}
	goto st57;
tr34:
#line 27 "../src/parsers/log.c.rl"
	{{( f.p) = (( f.te))-1;}{
        f.branch = 2;
